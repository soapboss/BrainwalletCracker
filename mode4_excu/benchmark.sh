...
# Using a smaller number due to BrainwalletIO's computational intensity
...
time ./brainflayer_brainwalletio -f benchmark_passphrases.txt -a benchmark_address.hash -o benchmark_found.hash -s "benchmark@example.com"

# Clean up
echo "Benchmark completed. Cleaning up..."
rm -f benchmark_passphrases.txt benchmark_address.hash benchmark_found.hash

echo "Note: BrainwalletIO is computationally intensive. Adjust config.yaml and batch sizes for optimal performance on your system." 